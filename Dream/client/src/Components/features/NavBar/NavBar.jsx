...
const NavBar = () => {
  ...
  const productLinks = (
    <>
      <NavLink to="/ProductShow/BeddingSleep">Bedding Sleep</NavLink>
      <NavLink to="/ProductShow/BeddingYouth">Bedding Youth</NavLink>
      <NavLink to="/ProductShow/BeddingChildren">Bedding Chinldren</NavLink>
      <NavLink to="/ProductShow/BeddingTransit">Bedding Transit</NavLink>
    </>
  );
